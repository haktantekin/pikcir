        ...
        <div className="overflow-hidden max-h-[700px] relative">
          ...
          <div className="flex justify-between gap-2 lg:gap-4  items-center flex-col lg:flex-row absolute bottom-2 left-2">
            <div className="flex gap-2">
              <button className="text-sm bg-BF4565 text-white p-1 lg:p-2 rounded font-bold flex gap-1 items-center" onClick={() => setPikOpened(true)}>
                <IconPhoto size={18} /> {pikCount} <span className="hidden lg:inline-block">Pik</span></button>
              <Modal opened={pikOpened} onClose={() => setPikOpened(false)} centered title="Pikleyen(ler)">
                <PikModal />
              </Modal>
              <button className="flex gap-1 items-center text-sm text-BF4565 border border-solid !border-BF4565 p-1 lg:p-2 rounded bg-white" onClick={toggle}>
