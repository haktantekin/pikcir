...
export default function ListItem({ link, value, count, item }: ListItemProps) {
  return (
    <>
      <Link href={link} className="bg-white min-h-[50px] rounded border border-e15146 border-dashed flex flex-col text-base mx-auto">
        <div className="pt-4 pl-4 text-e15146">
