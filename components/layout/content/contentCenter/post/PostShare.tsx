...
import { IconSettings, IconSearch, IconPhoto, IconMessageCircle, IconTrash, IconArrowsLeftRight, IconShare3, IconBrandFacebook, IconBrandTwitter, IconBrandWhatsapp, IconLink } from '@tabler/icons-react';
