...
import { IconAward, IconAwardFilled, IconBellRinging, IconHash, IconHome2, IconMoodSearch, IconListDetails } from "@tabler/icons-react";
  ...
  return (
    <>
      <Menu>
        ...
        <Menu.Item href={"/home"} component="a" icon={<IconUserCircle size={25} stroke={0.5} />} className="text-sm pb-0">
          Profilim
        </Menu.Item>
        <Menu.Item href={"javascript:;"} component="a" icon={<IconMoodWink size={25} stroke={0.5} />} className="text-sm pb-0">
          Piklediklerim
        </Menu.Item>
        <Menu.Item href={"javascript:;"} component="a" icon={<IconPackage size={25} stroke={0.5} />} className="text-sm pb-0">
          Koleksiyonlarım
        </Menu.Item>
        <Menu.Item icon={<IconMoodSearch size={25} stroke={0.5} />} className="text-sm">
          Keşfet
        </Menu.Item>
        <Menu.Divider />
        ...
        <Menu.Divider />
        <Menu.Item href={"javascript:;"} component="a" color="red" icon={<IconLogout2 size={25} stroke={0.5} />} className="text-sm">
          Çıkış Yap
        </Menu.Item>
        <Menu.Divider />
