...
export default function ShowProfile({profileShow}:ShowProfileProps) {
  return (
    <>
      ...
      <div className='absolute min-h-[100px]  min-w-[200px] right-0 bg-white mt-[2px] border border-ffbeb9 z-20' style={{ boxShadow: ' rgba(240, 113, 103, 0.4) 5px 5px, rgba(240, 113, 103, 0.3) 10px 10px, rgba(240, 113, 103, 0.2) 15px 15px, rgba(240, 113, 103, 0.1) 20px 20px, rgba(240, 113, 103, 0.05) 25px 25px' }}>
